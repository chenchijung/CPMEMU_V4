...
#
OPTIONS	= -DGNU_READLINE -static -static-libgcc -static-libstdc++ -s			#yaze-ag 2.51.3 Z80 engine
#OPTIONS = -DGNU_READLINE -static -static-libgcc -static-libstdc++ -s -DZ80_YAZE110  #yaze110 z80 engine
...
OBJS     = cpmemu.o cpmbdos.o mem_mmu.o cpmbios.o cpmglob.o cpmemuin.o simz80.o simz80_yaze110.o	
...
SRCS	      = cpmemu.c mem_mmu.c cpmbdos.c cpmbios.c cpmemuin.c cpmglob.c simz80.c simz80_yaze110.c
